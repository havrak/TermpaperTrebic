...
\def\KlicovaSlova{%
	{Třebíč}, {Židovský národ}, {Židé na Moravě}, {Historie Židovstva}, {Podklášteří}
}
\def\KlicovaSlovaEN{%
	{Trebitsh}, {Jewish nation}, {Jews in Moravia}, {Jewsish history}, {Podklášteří}
}
...
Kolik obětí bylo v židovském městě a Podklášteří nevíme, díky horším hygienickým podmínkám a většímu zalidnění byl pravděpodobně vyšší.\footnote{srov. \bibentry{Svobodva2015} str. 50}
...
\begin{figure}[h]
	...
	\caption[Mapa židovský města \text{[online]} Mapy.cz. Dostupné z: \url{https://en.mapy.cz/zakladni?x=15.8789945&y=49.2182114&z=17&source=muni&id=5517} \text{[cit. 2020-03-28], zeditováno}]{
		Mapa židovský města
	}
	\label{fig:zhh}
\end{figure}
