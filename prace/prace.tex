...
U něho prochází historii od raných počátků židovského osídlení přes tvorbu ghetta po konec osídlení způsobený nacistickou genocidou.
...
\def\AbstraktEN{%
Main topic of this paper is Jewish town in Třebíč.
At the beginning it goes trough history of Třebíč as a whole and then focuses solely on Jewish town.
There it first describes its history form the beginning of Jewish settlement here to end of Jewish community caused by the Nazi genocide.
...
\def\KlicovaSlova{%
	{Třebíč}, {Židovsto}, {Židé na Moravě}, {Historie Židovstva}, {Podklášteří}
}
\def\KlicovaSlovaEN{%
