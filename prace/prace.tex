...
%\subsubsection{Správa města}
%V čele města je v jeho počátcích rychtář, v polovině 14. století má lid snahu získat větší kontrolou nad rozhodováním, postupně se tedy přejde k radnici.
%Samotné právo města je založeno na větší a menší privilegium města Brna, přinesené původně německými kolonizátory v roce 1243.
%To se koncem 13. století stává součástí městského práva ustanovení o samosprávě.
