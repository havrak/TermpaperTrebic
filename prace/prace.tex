...
Je možné, že na území Třebečského lesa\footnote{území, na kterém byla založena Třebíč} se nacházelo i prehistorické osídlení, o tom však nemáme důkazy\footnote{srov. \bibentry{Uhlir1978}: 14}.
...
Je zajímavé, že markrabský titul vyjadřoval podřízenost českému králi, nikoliv králi Svaté říše římské.\footnote{srov. \bibentry{Wihoda2010}: 237, 241, 242}
...
Třebíč byla po válkách věrný králi Jiřímu z Poděbrad. \footnote{srov. \bibentry{Uhlir1978}: 49--54}
...
Po celých sedm let bylo město opuštěné. \footnote{srov. \bibentry{Uhlir1978}: 54--46}
...
Ten již Třebíč převádí do dědičného vlastnictví. \footnote{srov. \bibentry{Uhlir1978}: 61--71}
...
V něm císař ponechal Třebíči soudní pravomoc, zároveň však apeloval, aby se Valdštejn na jurisdikci podílel a zaručil také měšťanům právo na svobodný trh. \footnote{srov. \bibentry{Janak1981}: 28--29}
...
% byly změny v židovském městě a samotní židé hodně ovlivňovaly politiku Třebíče, budu se věnovat v samostatné kapitole o městě
...
Až úřední dokumenty z 16. století nám poskytují možnost lépe poznat osudy města.\footnote{srov. \bibentry{Fiser2005}: 10}
...
Původně se však byl vznik zasazen do roku 978 dle historika J. E. Horkého, toho však J. Kořatek \uv{opravil} na již zmíněný rok 933.
...
Jestli však byl skutečně napsán v Třebíči, tak muselo ghetto vzniknout dlouho před rokem 1300 a v době napsání být jedním z významnějších na Moravě.\footnote{srov. \bibentry{Putik2015}: 24}
...
I o výkladu této poznámky se vedou spory někteří historikové hovoří až o vypálení několika domů v Podklášteří\footnote{srov. \bibentry{Klenovsky2003}: 4}, jíní jen o zajetí jednoho či více Židů kteří z Třebíče\footnote{srov. \cite{Fiser2005}: 22}.
Zároveň se ve městské knize dočteme o zastavení opatské mitry Židem.
Obecně se rok 1410 pokládá za první definitivní důkaz existence židovského města, dočteme se o něm i v úspěšném titulu Historie Židů od Tomáše Pěkného\footnote{srov. \bibentry{Pekny2001}: 419}.
...
Těsně po skončení války se začíná i budovat \uv{Přední} synagoga.
...
Již v roce 1724 požádala obec o stvrzení starých \uv{svobod}.\footnote{srov. \cite{Fiser2005}: 26}
...
To na \uv{popularitě} Židů žijící v Třebíči nijak nepřidalo.\footnote{srov. \cite{Janak1981}: 93}
